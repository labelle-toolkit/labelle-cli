...
pub fn printHelp() void {
    std.debug.print(
        ...
        \\  build [dir] [--scene=<name>] [--platform=<p>] [--optimize=<mode>]  Generate + build the project
        \\  run [dir] [--timeout=<dur>] [--scene=<name>] [--platform=<p>] [--optimize=<mode>]  Generate + build + run (default)
